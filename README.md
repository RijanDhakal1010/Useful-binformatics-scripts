# The folders are demarcated accoridng to the language they hold. This repos is for scripts/code and scripts/code only. Any data can sit separately on Google drive and notion. 
